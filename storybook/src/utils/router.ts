...
const PAGE_TO_PATH: Record<string, string> = {
  ...
  'pattern-inline-feedback-error': 'patterns/feedback-and-communication/inline-feedback-and-status-communication/inline-feedback-error',
  'inline-feedback-error': 'patterns/feedback-and-communication/inline-feedback-and-status-communication/inline-feedback-error',
  'pattern-inline-feedback-hint': 'patterns/feedback-and-communication/inline-feedback-and-status-communication/inline-feedback-hint',
  ...
  'pattern-help-center': 'patterns/feedback-and-communication/contact-and-support/help-center',
  ...
  'pattern-file-complaint': 'patterns/feedback-and-communication/contact-and-support/file-a-complaint',
  'file-complaint': 'patterns/feedback-and-communication/contact-and-support/file-a-complaint',
  'file-a-complaint': 'patterns/feedback-and-communication/contact-and-support/file-a-complaint',
  'pattern-file-a-complaint': 'patterns/feedback-and-communication/contact-and-support/file-a-complaint',
  'pattern-find-service-center': 'patterns/feedback-and-communication/contact-and-support/find-service-centre',
...
export function getPageFromPath(path: string): string {
  ...
  if (cleanPath.startsWith('patterns/') || cleanPath.startsWith('patterns') || cleanPath.startsWith('pattern')) {
    ...
    if (cleanPath.includes('file-complaint') || cleanPath.includes('file-a-complaint') || cleanPath.includes('complaint')) {
      return 'pattern-file-complaint';
    }
    ...
    if (cleanPath.includes('inline-feedback-hint')) {
      return 'pattern-inline-feedback-hint';
    }
    ...
    if (cleanPath.includes('inline-feedback-note') || cleanPath.includes('note')) {
      return 'pattern-inline-feedback-note';
    }
