        ...
        children: [
          {
            ...
            children: [
              ...
              {
                id: 'pattern-search-with-results',
                label: 'Search with Results',
                icon: 'layers',
              },
              {
                id: 'pattern-search-results-list',
          ...
          },
          {
            ...
            children: [
              ...
              {
                id: 'pattern-category-service-list',
          ...
          },
          {
            ...
            children: [
              ...
              {
                id: 'pattern-appointment-confirmed',
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                id: 'pattern-inline-feedback-error',
                label: 'Inline Feedback Error',
                icon: 'layers',
              },
              {
                id: 'pattern-inline-feedback-hint',
                label: 'Inline Feedback Hint',
                icon: 'layers',
              },
              {
                id: 'pattern-inline-feedback-guidance',
                label: 'Inline Feedback Guidance',
                icon: 'layers',
              },
              {
                id: 'pattern-inline-feedback-verification',
