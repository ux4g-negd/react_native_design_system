...
export const WhatsAppConsentDoc: React.FC<WhatsAppConsentDocProps> = ({ isDark }) => {
  ...
  const colors = useMemo(() => {
    ...
    return {
      ...
      primary,
      bannerBg: isDark ? '#064E3B' : '#ECFDF5',
      bannerBorder: isDark ? '#059669' : '#A7F3D0',
...
const styles = StyleSheet.create({
  ...
  banner: { backgroundColor: '#ECFDF5', borderRadius: 8, borderWidth: 1, borderColor: '#A7F3D0', padding: 16 },
