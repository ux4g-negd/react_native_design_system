...
interface ForgotPasswordEnterOtpDocProps {
  isDark: boolean;
}
...
export const ForgotPasswordEnterOtpDoc: React.FC<ForgotPasswordEnterOtpDocProps> = ({ isDark }) => {
  ...
  // Clean React Native TSX code snippet matching Flutter fpStep2Component
...
export const ResetPasswordEnterOtpCardPattern = () => {
      ...
      <View style={styles.cardContainer}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.card}>
            ...
            <View style={{ height: 6 }} />
            <Text style={styles.subtitleText}>Sent to +91 98765 XXXXX</Text>
...
export const ResetPasswordEnterOtpDefaultPattern = () => {
  const [otp, setOtp] = useState('');
...
const styles = StyleSheet.create({
  ...
  // Interactive Live Mockup for Web Preview (1:1 match with Flutter FP Step 2)
      ...
      >
        ...
        {isCard ? (
            ...
            <div style={{ padding: '16px', flex: 1, overflow: 'auto' }}>
              ...
              >
                ...
                <Ux4gOtpInput
                  ...
                  captionTrailingText="Resend"
                  autoCountdownSeconds={60}
                  onCaptionTrailingTap={handleResend}
                />
          ...
          >
            ...
            {/* Verify Button + Footer at bottom */}
            <div>
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        ...
        <p className="wb-subtitle">
          OTP verification screen for the password reset flow.
        </p>
      </div>
