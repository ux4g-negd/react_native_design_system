...
export const StepperDoc: React.FC<StepperDocProps> = ({ isDark, story = 'stepper-horizontal' }) => {
  ...
  const renderStoryPreview = () => {
    const snackUrl = `https://snack.expo.dev/embedded?platform=android&supportedPlatforms=ios,android&theme=${isDark ? 'dark' : 'light'}&name=Ux4gStepper%20Preview&preview=true&hideNavigation=true&hideDevTools=true&hideConsole=true&dependencies=ux4g-react-native-design-system@1.0.8-beta.0,react-native-svg@*&code=${encodeURIComponent(codeString)}`;
