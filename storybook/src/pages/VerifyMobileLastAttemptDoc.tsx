...
interface VerifyMobileLastAttemptDocProps {
  isDark: boolean;
}
...
export const VerifyMobileLastAttemptDoc: React.FC<VerifyMobileLastAttemptDocProps> = ({ isDark }) => {
  ...
  const colors = useMemo(() => {
    return {
      ...
      // Error Banner Tokens (escalated for last attempt)
      ...
      bannerSubtitle: isDark ? UX4GColors.red300 : UX4GColors.red800, // #FFA3A3 / #800000
      badgeBg: isDark ? UX4GColors.red800 : UX4GColors.red100, // #800000 / #FFE0E0
      badgeText: isDark ? UX4GColors.red300 : UX4GColors.red800, // #FFA3A3 / #800000
  ...
  // Clean React Native TSX code snippet matching Flutter otpVerifyLastAttemptComponent
...
export const VerifyMobileLastAttemptCardPattern = () => {
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.cardContainer}>
        ...
        <View style={styles.card}>
          ...
          {/* Error-styled banner escalated for final attempt */}
          <Ux4gStatusBanner
            variant="errorLight"
            ...
            leadingIcon={<ErrorIcon size={20} color={UX4GColors.red600} />}
            subtitleWidget={
              <View style={styles.bannerSubtitleRow}>
                ...
                <View style={styles.attemptBadge}>
                  <Text style={styles.attemptBadgeText}>Attempt 2 of 3</Text>
                </View>
              </View>
            }
          />
...
const styles = StyleSheet.create({
  ...
  attemptBadge: {
    backgroundColor: UX4GColors.red100,
...
export const VerifyMobileLastAttemptDefaultPattern = () => {
  const [otp, setOtp] = useState('');
            ...
            <div>
              ...
              >
                ...
                <div style={{ marginTop: 20 }}>
                  <Ux4gOtpInput
                    key="verify_mobile_last_attempt_card"
                    length={6}
                    value={otp}
          ...
          >
            <div>
              ...
              <div style={{ marginTop: 24 }}>
                <Ux4gOtpInput
                  key="verify_mobile_last_attempt_default"
                  length={6}
                  value={otp}
                  onChanged={(val) => setOtp(val)}
                  boxSize={44}
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        <div className="wb-header-row">
          <h1 className="wb-title">Verify mobile with last-attempt warning</h1>
          <span className="wb-badge">Pattern</span>
        </div>
        <p className="wb-subtitle">
          Mobile-number OTP verification on the final attempt showing an error-styled banner warning the user that one more wrong entry will lock the account for 30 minutes. Toggle between the flat layout and the card-style layout. Mobile-sized layout (360px).
        </p>
      </div>
            ...
            {activeMainTab === 'code' && (
              <div className="wb-code-area">
                ...
                <CodeBlock
                  code={codeString}
                  language="TSX"
                  filename={variant === 'card' ? 'VerifyMobileLastAttemptCardPattern.tsx' : 'VerifyMobileLastAttemptDefaultPattern.tsx'}
                />
              </div>
            )}
          </div>
...
export default VerifyMobileLastAttemptDoc;
