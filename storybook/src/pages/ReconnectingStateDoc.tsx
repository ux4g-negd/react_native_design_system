...
interface ReconnectingStateDocProps {
  isDark: boolean;
}

type MainTab = 'preview' | 'code';

export const ReconnectingStateDoc: React.FC<ReconnectingStateDocProps> = ({ isDark }) => {
  const [activeMainTab, setActiveMainTab] = useState<MainTab>('preview');

  // Colors matching Flutter proactive_status_update_stories.dart for stateVariant = 'reconnecting'
  ...
  // Clean TSX Code string matching Flutter _getProactiveStatusCode('reconnecting')
...
export const ReconnectingStatePattern = () => {
  return (
    <View style={styles.screen}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16, paddingBottom: 20 }}>
        ...
        {/* Card 1: Application Status with Reconnecting Amber Badge */}
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        <div className="wb-header-row">
          <h1 className="wb-title">Reconnecting State</h1>
          <span className="wb-badge">Pattern</span>
        </div>
        <p className="wb-subtitle">
          Demonstrates the application card view when real-time connection drops (Reconnecting amber badge).
        </p>
      </div>
