...
interface DataSharingConsentDocProps {
  isDark: boolean;
}
...
export const DataSharingConsentDoc: React.FC<DataSharingConsentDocProps> = ({ isDark }) => {
  ...
  const colors = useMemo(() => {
    return {
      ...
      dpdpBg: isDark ? UX4GColors.primary900 : UX4GColors.primary100,
      dpdpText: isDark ? UX4GColors.primary300 : UX4GColors.primary600,
      requiredTagBg: isDark ? UX4GColors.red900 : '#FFF0F0',
      requiredTagText: isDark ? UX4GColors.red300 : '#8A1A16',
      optionalTagBg: isDark ? UX4GColors.gray800 : '#F3F4F6',
      optionalTagText: isDark ? UX4GColors.neutral400 : UX4GColors.neutral600,
      ...
      cancelText: isDark ? UX4GColors.neutral400 : UX4GColors.neutral700,
    };
  }, [isDark, variant]);
...
export const DataSharingConsentPattern = ({
  ...
  const sharingItems = [
    { title: 'Bank of India', shared: 'Aadhaar, Name', purpose: 'Account matching', duration: '1 year', isRequired: true },
    { title: 'Payment Corp', shared: 'Transaction ID', purpose: 'Payment processing', duration: '90 days', isRequired: true },
    { title: 'SMS Gateway', shared: 'Mobile Number', purpose: 'Status alerts', duration: 'Scheme duration', isRequired: false },
  ];
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={isCard ? [styles.cardContainer, { backgroundColor: isDark ? UX4GColors.gray900 : '#FFFFFF' }] : styles.flatContainer}>
          ...
          <View style={styles.titleSection}>
            <Text style={[styles.sectionTitle, { color: isDark ? UX4GColors.neutral50 : UX4GColors.gray900 }]}>
              Data Sharing Consent
            </Text>
            <Ux4gTag
              text="DPDP Act 2023"
              customBackgroundColor={isDark ? UX4GColors.primary900 : UX4GColors.primary100}
              customContentColor={isDark ? UX4GColors.primary300 : UX4GColors.primary600}
              shape="circular"
              size="m"
            />
          </View>
            ...
            <View key={index} style={[styles.dataCard, { backgroundColor: isDark ? UX4GColors.gray900 : '#FFFFFF', borderColor: isDark ? UX4GColors.neutral800 : UX4GColors.neutral200 }]}>
              <View style={styles.dataCardRow}>
                ...
                <Ux4gTag
                  ...
                  customBackgroundColor={item.isRequired ? (isDark ? UX4GColors.red900 : '#FFF0F0') : (isDark ? UX4GColors.gray800 : '#F3F4F6')}
                  customContentColor={item.isRequired ? (isDark ? UX4GColors.red300 : '#8A1A16') : (isDark ? UX4GColors.neutral400 : UX4GColors.neutral600)}
                  shape="circular"
                  size="m"
                />
              </View>
          ...
          {/* Actions */}
          <View style={{ gap: 4 }}>
            <Ux4gButton text="Manage" variant="outline" height={48} size="large" />
            <Ux4gButton text="Cancel" variant="outline" contentColor={isDark ? UX4GColors.neutral400 : UX4GColors.neutral700} borderColor={isDark ? UX4GColors.neutral600 : UX4GColors.neutral300} height={48} size="large" />
          </View>
        </View>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  headline: { fontSize: 20, fontWeight: '600', textAlign: 'center', marginBottom: 16 },
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <span
          style={{
            ...
            padding: '2px 10px',
            borderRadius: 12,
            backgroundColor: isRequired ? colors.requiredTagBg : colors.optionalTagBg,
            color: isRequired ? colors.requiredTagText : colors.optionalTagText,
            lineHeight: '1.2',
          }}
        >
  ...
  const renderMockupContent = () => (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 8, marginBottom: 12 }}>
        <span style={{ fontSize: 20, fontWeight: 600, color: colors.titleColor, letterSpacing: '-0.01em' }}>
          Data Sharing Consent
        </span>
        <span
          style={{
            ...
            padding: '2px 10px',
            borderRadius: 12,
            backgroundColor: colors.dpdpBg,
            color: colors.dpdpText,
            lineHeight: '1.2',
          }}
        >
          DPDP Act 2023
      ...
      {/* Sharing Cards */}
      {renderSharingCard('Bank of India', 'Aadhaar, Name', 'Account matching', '1 year', true)}
      {renderSharingCard('Payment Corp', 'Transaction ID', 'Payment processing', '90 days', true)}
      {renderSharingCard('SMS Gateway', 'Mobile Number', 'Status alerts', 'Scheme duration', false)}
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        <div className="wb-header-row">
          <h1 className="wb-title">Data Sharing Consent</h1>
...
export default DataSharingConsentDoc;
