...
interface JourneyProgressIndicatorDocProps {
  isDark: boolean;
}
...
export const JourneyProgressIndicatorDoc: React.FC<JourneyProgressIndicatorDocProps> = ({ isDark }) => {
  ...
  const renderStepper = () => (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      >
        ...
        {/* Step 3: Current / Active (Ring with center dot & label) */}
        <div
          style={{
            flex: 1,
            display: 'flex',
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        <div className="wb-header-row">
          <h1 className="wb-title">Journey Progress Indicator</h1>
...
export default JourneyProgressIndicatorDoc;
