...
interface AadhaarOtpEnterDocProps {
  isDark: boolean;
}
...
export const AadhaarOtpEnterDoc: React.FC<AadhaarOtpEnterDocProps> = ({ isDark }) => {
    ...
    <View style={[styles.container, { backgroundColor: isDark ? UX4GColors.primary800 : UX4GColors.primary100 }]}>
      ...
      <View style={styles.cardWrapper}>
        <View style={[styles.card, { backgroundColor: isDark ? UX4GColors.neutral900 : UX4GColors.neutral50 }]}>
          ...
          {/* Labeled OTP Input with Resend Timer */}
          <Ux4gOtpInput
            key={\`aadhaar_otp_card_\${resendNonce}\`}
            length={6}
            value={otp}
            onChanged={setOtp}
            label="Enter OTP"
      ...
      <div className="wb-header">
        <div>
          <div className="wb-breadcrumb">
            <span>Patterns</span> / <span>Identity and Access</span> / <span>Aadhaar Authentication Gate</span> / <span className="active">Aadhaar OTP — enter code</span>
          </div>
          <h1 className="wb-title">Aadhaar OTP — enter code</h1>
          <p className="wb-subtitle">
            OTP entry step shown after the user picks "Aadhaar OTP" on the verify-with-Aadhaar method picker. Includes a "Change method" link back to the picker, a labeled OTP field with a 60-second resend timer, and a Back + Verify OTP action footer.
          </p>
        </div>
      </div>
            ...
            {activeMainTab === 'code' && (
              <div className="wb-code-area">
                ...
                <CodeBlock
                  code={codeString}
                  language="TSX"
                  filename={variant === 'card' ? 'AadhaarOtpEnterCardPattern.tsx' : 'AadhaarOtpEnterDefaultPattern.tsx'}
                />
              </div>
            )}
          </div>
...
export default AadhaarOtpEnterDoc;
