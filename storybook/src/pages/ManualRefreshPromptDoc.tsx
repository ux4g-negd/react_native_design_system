...
interface ManualRefreshPromptDocProps {
  isDark: boolean;
}

type MainTab = 'preview' | 'code';

export const ManualRefreshPromptDoc: React.FC<ManualRefreshPromptDocProps> = ({ isDark }) => {
  const [activeMainTab, setActiveMainTab] = useState<MainTab>('preview');
  const [isBannerVisible, setIsBannerVisible] = useState<boolean>(true);

  // Colors matching Flutter proactive_status_update_stories.dart for stateVariant = 'refresh'
  ...
  // Clean TSX Code string matching Flutter _getProactiveStatusCode('refresh')
...
export const ManualRefreshPromptPattern = () => {
  ...
  return (
    <View style={styles.screen}>
      ...
      {/* 3. Floating Bottom Toast Banner (Manual Refresh Prompt) */}
      {bannerVisible && (
        <View style={styles.floatingToastContainer}>
          <Ux4gToast
            category="info"
            title="Check Status"
            subtitle="Tap refresh to see the latest status. Your view will not change automatically."
  ...
  const renderLiveMockup = () => {
    return (
      ...
      >
        ...
        {/* Floating Bottom Toast Banner (Manual Refresh Prompt) */}
        {isBannerVisible && (
          <div
            style={{
              position: 'absolute',
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        <div className="wb-header-row">
          <h1 className="wb-title">Manual Refresh Prompt</h1>
          <span className="wb-badge">Pattern</span>
        </div>
        <p className="wb-subtitle">
          Demonstrates a persistent bottom banner prompting the citizen to manually tap refresh when real-time feed is disabled.
        </p>
      </div>
