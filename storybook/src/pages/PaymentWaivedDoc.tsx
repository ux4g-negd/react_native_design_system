...
interface PaymentWaivedDocProps {
  isDark: boolean;
}
...
export const PaymentWaivedDoc: React.FC<PaymentWaivedDocProps> = ({ isDark }) => {
  ...
  const colors = useMemo(() => {
    ...
    return {
      ...
      subtleText: isDark ? UX4GColors.neutral200 : UX4GColors.neutral500,
      primary: UX4GColors.primary,
      primaryLight: UX4GColors.primary300,
      // Success green palette tokens from Flutter (Ux4gColors.green800 / green100 / green600 / green)
  ...
  // Clean React Native TSX code snippet matching Flutter feeWaivedComponent
...
export const PaymentWaivedCardPattern = ({ isDark }: { isDark: boolean }) => {
  const details = [
          ...
          >
            {details.map((row, idx) => (
              <View key={idx} style={styles.detailRow}>
                <Text style={[styles.detailLabel, { color: isDark ? UX4GColors.neutral200 : UX4GColors.neutral500 }]}>
                  {row.label}
                </Text>
                <Text
                  style={[
...
export const PaymentWaivedDefaultPattern = ({ isDark }: { isDark: boolean }) => {
  const details = [
    { label: 'Application fee', value: 'Rs 30.00' },
    { label: 'Processing charge', value: 'Rs 5.00' },
    { label: 'GST 18%', value: 'Rs 6.30' },
...
const styles = StyleSheet.create({
  ...
  // Live interactive mockup matching Flutter feeWaivedComponent (_FeeWaivedMockup / _FeeWaivedCardMockup) EXACTLY
    ...
    <div className="wb-page">
      ...
      <div className="wb-header">
        <div className="wb-header-row">
          <h1 className="wb-title">Payment Waived</h1>
          <span className="wb-badge">Pattern</span>
        </div>
        <p className="wb-subtitle">
          Screen shown for applicants eligible for a full fee waiver (e.g. SC/ST category). Shows the waiver breakdown with a negative row and Rs 0.00 total. Toggle between flat phone layout and card-style layout. Mobile-sized layout (360px).
        </p>
      </div>
