...
interface AuthSuspiciousActivityDocProps {
  isDark: boolean;
}
...
export const AuthSuspiciousActivityDoc: React.FC<AuthSuspiciousActivityDocProps> = ({ isDark }) => {
  ...
  // Exact TSX Code Strings matching Flutter Widgetbook _authOtpSuspiciousActivityCode & _authOtpSuspiciousActivityCardCode
    ...
    <View style={[styles.container, { backgroundColor: isDark ? UX4GColors.primary800 : UX4GColors.primary100 }]}>
      ...
      <View style={styles.cardWrapper}>
        <View style={[styles.card, { backgroundColor: isDark ? UX4GColors.neutral900 : UX4GColors.neutral50 }]}>
          ...
          {/* Warning Banner - Suspicious activity detected */}
          <Ux4gStatusBanner
            variant="warningLight"
            title="Suspicious activity detected"
            subtitle="We detected a sign-in from a new device. Please verify your identity before continuing."
            ...
            titleStyle={{
              fontSize: 14,
              fontWeight: '700',
              color: isDark ? UX4GColors.orange300 : UX4GColors.orange800,
            }}
            subtitleStyle={{
              fontSize: 14,
              fontWeight: '400',
          ...
          {/* OTP Input - Resend Timer Caption */}
          <Ux4gOtpInput
            key={\`auth_stepup_card_otp_\${resendNonce}\`}
            length={6}
            value={otp}
            onChanged={setOtp}
            boxSize={44}
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? UX4GColors.gray900 : UX4GColors.neutral0 }]}>
      ...
      <View style={styles.content}>
        ...
        {/* OTP Input - Resend Timer Caption */}
        <Ux4gOtpInput
          key={\`auth_stepup_otp_\${resendNonce}\`}
          length={6}
          value={otp}
          onChanged={setOtp}
          boxSize={44}
          ...
          >
            <div>
              ...
              >
                ...
                {/* Orange Warning Banner: Suspicious activity detected */}
                <div
                  style={{
      ...
      <div className="wb-header">
        <div>
          <div className="wb-breadcrumb">
            <span>Patterns</span> / <span>Identity and Access</span> / <span>Auth errors and lockout</span> / <span className="active">OTP step-up — suspicious activity</span>
          </div>
          <h1 className="wb-title">OTP step-up — suspicious activity</h1>
          <p className="wb-subtitle">
            Step-up authentication screen shown when the system detects a sign-in from a new device or other suspicious signal. A multi-line warning banner explains the reason, followed by a fresh OTP entry field.
          </p>
        </div>
      </div>
            ...
            {activeMainTab === 'code' && (
              <div className="wb-code-area">
                ...
                <CodeBlock
                  code={codeString}
                  language="TSX"
                  filename={variant === 'card' ? 'AuthOtpSuspiciousActivityCardPattern.tsx' : 'AuthOtpSuspiciousActivityDefaultPattern.tsx'}
                />
              </div>
            )}
          </div>
...
export default AuthSuspiciousActivityDoc;
