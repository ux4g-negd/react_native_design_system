...
interface AuthRetryUnlockedDocProps {
  isDark: boolean;
}
...
export const AuthRetryUnlockedDoc: React.FC<AuthRetryUnlockedDocProps> = ({ isDark }) => {
  ...
  const colors = useMemo(() => {
    return {
      ...
      bannerTitle: isDark ? UX4GColors.green300 : UX4GColors.green800,
      bannerIcon: isDark ? UX4GColors.green500 : UX4GColors.green600,
    };
  }, [isDark]);

  // Exact TSX Code Strings matching Flutter Widgetbook _authOtpRetryUnlockedCode & _authOtpRetryUnlockedCardCode
    ...
    <View style={[styles.container, { backgroundColor: isDark ? UX4GColors.primary800 : UX4GColors.primary100 }]}>
      ...
      <View style={styles.cardWrapper}>
        <View style={[styles.card, { backgroundColor: isDark ? UX4GColors.neutral900 : UX4GColors.neutral50 }]}>
          ...
          {/* Success Banner - Unlocked confirmation */}
          <Ux4gStatusBanner
          ...
          <Ux4gOtpInput
            key={\`auth_retry_card_otp_\${resendNonce}\`}
            length={6}
            value={otp}
            onChanged={setOtp}
            boxSize={44}
  ...
  return (
    <View style={[styles.container, { backgroundColor: isDark ? UX4GColors.gray900 : UX4GColors.neutral0 }]}>
      ...
      <View style={styles.content}>
        ...
        {/* OTP Input - Resend Timer Caption */}
        <Ux4gOtpInput
          key={\`auth_retry_otp_\${resendNonce}\`}
          length={6}
          value={otp}
          onChanged={setOtp}
          boxSize={44}
          ...
          >
            <div>
              ...
              >
                ...
                {/* Green Success Banner: Unlocked confirmation */}
                <div
                  style={{
      ...
      <div className="wb-header">
        <div>
          <div className="wb-breadcrumb">
            <span>Patterns</span> / <span>Identity and Access</span> / <span>Auth errors and lockout</span> / <span className="active">OTP retry — unlocked</span>
          </div>
          <h1 className="wb-title">OTP retry — unlocked</h1>
          <p className="wb-subtitle">
            Recovery screen shown after a 30-min lockout window has expired. A green "You can now try signing in again" success banner sits above a fresh OTP entry field with the resend-timer caption.
          </p>
        </div>
      </div>
            ...
            {activeMainTab === 'code' && (
              <div className="wb-code-area">
                ...
                <CodeBlock
                  code={codeString}
                  language="TSX"
                  filename={variant === 'card' ? 'AuthOtpRetryUnlockedCardPattern.tsx' : 'AuthOtpRetryUnlockedDefaultPattern.tsx'}
                />
              </div>
            )}
          </div>
...
export default AuthRetryUnlockedDoc;
